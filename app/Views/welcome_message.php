...
<body>
    ...
    <section>
        ...
        <h1>MakeFoodAPP API by Samuel Adoga</h1>

        <p>To Login:: makefoodapp.herokuapp.com/login</p>
        <p> Pass along email and password (min of 5 chars)</p>

        <br />
        <br />

        <p>To Register:: makefoodapp.herokuapp.com/register</p>
        <p> Pass along name, email and password (min of 5 chars)</p>

        <br />
        <br />

        <p>View Authorized content:: makefoodapp.herokuapp.com/posts</p>
